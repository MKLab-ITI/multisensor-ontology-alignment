/*
 * $Id: BasicAlignment.java 1866 2014-01-14 14:34:59Z euzenat $
 *
 ...
 * @version $Id: BasicAlignment.java 1866 2014-01-14 14:34:59Z euzenat $
 */
...
public class BasicAlignment implements Alignment {
    ...
    /*
     * Babis: I implemented addCell2() as addCell() was not visible outside BasicAlignment
     */
    ...
    /*
     * Babis: I implemented remCell2() as I had problems with remCell() and c.getObject1()
     */
    public void remCell2(Cell c) throws AlignmentException {
    	Object o1 = c.getObject1();
    	Enumeration<Object> keys = hash1.keys();
    	Object key = null;
    	boolean found = false;
    	while (keys.hasMoreElements()) {
    		key = keys.nextElement();
    		if (o1.toString().equals(key.toString())) {
    			found = true;
    			break;
    		}
    	}
